  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[2rem] border border-stone-300/70 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none">
        ...
        <h2 className="mt-3 font-serif text-4xl text-stone-950 dark:text-white">이미지 자산</h2>
      ...
      <form className="space-y-4 rounded-[1.75rem] border border-stone-300/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none">
        <div className="grid gap-4 lg:grid-cols-2 2xl:grid-cols-[1.2fr_0.85fr_0.85fr_0.85fr_1fr]">
          ...
          <label className="block min-w-0">
            <span
              className={`mb-2 block text-[11px] uppercase tracking-[0.18em] ${
                mime ? "text-amber-700 dark:text-amber-200" : "text-stone-500 dark:text-stone-400"
              }`}
            >
              MIME 타입
            </span>
          ...
          <label className="block min-w-0">
            <span
              className={`mb-2 block text-[11px] uppercase tracking-[0.18em] ${
                normalizedKind ? "text-amber-700 dark:text-amber-200" : "text-stone-500 dark:text-stone-400"
              }`}
            >
              자산 종류
            </span>
          ...
          <label className="block min-w-0">
            <span
              className={`mb-2 block text-[11px] uppercase tracking-[0.18em] ${
                normalizedUsage ? "text-amber-700 dark:text-amber-200" : "text-stone-500 dark:text-stone-400"
              }`}
            >
              사용처
            </span>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div className="rounded-[1.75rem] border border-stone-300/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none">
          ...
          <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">저장된 전체 이미지 자산 수</p>
        </div>
        <div className="rounded-[1.75rem] border border-stone-300/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none">
          <p className="text-xs uppercase tracking-[0.25em] text-stone-400">
            Storage
          ...
          <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">누적 파일 용량</p>
        </div>
        <div className="rounded-[1.75rem] border border-stone-300/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none">
          <p className="text-xs uppercase tracking-[0.25em] text-stone-400">
            Latest Upload
          ...
          <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">가장 최근 업로드 시각</p>
        </div>
        <div className="rounded-[1.75rem] border border-stone-300/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none">
          <p className="text-xs uppercase tracking-[0.25em] text-stone-400">
            Alt Text
          ...
          <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">alt 텍스트가 채워진 자산 수</p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        <a
          ...
          className="rounded-full border border-stone-300/70 bg-white px-4 py-2 text-sm text-stone-700 transition hover:border-stone-400 hover:bg-stone-100 dark:border-white/15 dark:bg-white/5 dark:text-stone-200 dark:hover:border-white/35"
        >
          실제 업로드 {kindStats.uploadedAssets}
        </a>
        <a
          href="/admin/assets?kind=load_test"
          className="rounded-full border border-amber-300/60 bg-amber-100/80 px-4 py-2 text-sm text-amber-900 transition hover:border-amber-400 hover:bg-amber-200/80 dark:border-amber-300/20 dark:bg-amber-400/10 dark:text-amber-100 dark:hover:border-amber-200/35"
        >
          LOAD TEST {kindStats.loadTestAssets}
        </a>
        <a
          href="/admin/assets?usage=unused"
          className="rounded-full border border-sky-300/35 bg-sky-50 px-4 py-2 text-sm text-sky-700 transition hover:border-sky-400 hover:bg-sky-100 dark:border-sky-300/20 dark:bg-sky-500/10 dark:text-sky-100 dark:hover:border-sky-200/35"
        >
          미사용 자산만 보기
        </a>
      ...
      <div className="rounded-[1.75rem] border border-stone-300/70 bg-white px-5 py-4 text-sm text-stone-600 shadow-sm dark:border-white/10 dark:bg-white/5 dark:text-stone-300 dark:shadow-none">
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
          <span>
            결과 <span className="font-medium text-stone-950 dark:text-white">{assetPage.totalCount}</span>개
          </span>
          ...
          <span className="text-stone-400 dark:text-stone-600">·</span>
          <span>
            현재 페이지 <span className="font-medium text-stone-950 dark:text-white">{assetPage.items.length}</span>개 표시
          </span>
        </div>
      </div>
      ...
      {assetPage.items.length ? (
        ...
        <div className="rounded-[1.75rem] border border-dashed border-stone-300/70 bg-white px-5 py-12 text-center shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none">
